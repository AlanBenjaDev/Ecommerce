...
function Header() {
  ...
  return (
    <motion.div className='min-h-screen bg-gradient-to-tr from-blue-100 to-white flex flex-col items-center justify-center text-center p-6'
...
>
      <h1 className='text-4xl font-bold text-gray-900 mb-6'>Bienvenido a ElectroShop</h1>
      ...
      {visible && (
        <div className='mt-4 flex flex-col gap-4'>
          ...
          <button
            ...
            className='bg-gray-700 text-white font-semibold px-5 py-3 rounded hover:bg-gray-800 shadow'
          >
            Ver Carrito
          </button>
        </div>
